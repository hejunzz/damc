...
python damc_source.py --model_ep $modelep --threshold $thresh --save $save --epsilon $epsilon --src_max_epoch $src_max_ep --smoothing $smooth --src_alpha $alpha --bn_dim $bndim --gpuid $gpu --task $task --seed $seed --num_c $num_c --source $source